<template>
    <div>
        <div class="row">
            <router-link to="" class="btn btn-primary" style="width: 140px;">All Employee</router-link>
        </div>
                ...
                <form class="user" @submit.prevent="employeeInsert" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="exampleInputFirstName" placeholder="Enter Your Sallery"
                    ...
                    <div class="form-group">
                        <div class="form-row">
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="exampleInputFirstName" placeholder="Enter Your Joining Date"
                                v-model="form.joining_date">
                                <small class="text-danger" v-if="errors.joining_date">{{ errors.joining_date[0] }}</small>
                            </div>
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="exampleInputFirstName" placeholder="Enter Your NID"
                                v-model="form.nid">
                    ...
                    <div class="form-group">
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                <img src="form.photo" alt="" style="height: 40px; width: 48px;">
                            </div>
                        </div>
                    </div>
